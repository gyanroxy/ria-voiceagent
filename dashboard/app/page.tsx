      ...
      <div className="z-10 flex flex-col items-center gap-12 w-full max-w-7xl">
        <header className="text-center space-y-4 animate-in fade-in slide-in-from-top-8 duration-700">
          ...
          <h1 className="text-6xl md:text-7xl font-extrabold tracking-tight">
            <span className="text-white">Ria Calling</span>
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500"> Agent</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto font-light leading-relaxed">
            Roxy Automobiles (రాక్సీ ఆటోమొబైల్స్) • Multilingual AI Telephony
          </p>
          <p className="text-sm text-purple-400 font-medium">
            Powered by Groq Brain & Sarvam Indian Voice AI (Telugu / Hindi / English)
          </p>
        </header>
