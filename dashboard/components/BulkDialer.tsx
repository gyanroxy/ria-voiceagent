            ...
            <div className="relative p-8 bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl">
                ...
                <form onSubmit={handleBulkDispatch} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            type="text"
                            placeholder="e.g. Roxy Automobiles - Overdue Credit Limit Reminder"
                            value={prompt}
                            onChange={(e) => setPrompt(e.target.value)}
                            className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent text-white placeholder-gray-600 outline-none transition-all duration-300 text-sm"
                        />
                    </div>
